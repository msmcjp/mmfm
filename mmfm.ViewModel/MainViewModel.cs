...
namespace Mmfm.ViewModel
{
    public class MainViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        {
            new CommandItemViewModel("Show settings", "Ctrl+OemComma", new Commands.AsyncRelayCommand(async () => await ShowSettingsAsync())),
        };
        ...
        private Func<FolderShortcutViewModel[]> CreateShortcutsGenerator(IEnumerable<FolderShortcutViewModel> extra) => () =>
        {
            var specialFolders = new FolderShortcutViewModel[] {
                ...
                new FolderShortcutViewModel(Environment.GetFolderPath(Environment.SpecialFolder.MyPictures), Properties.Resources.MyPictures, defaultItemGroup, IconExtractor.Extract("shell32.dll", 127, true) )
            };
